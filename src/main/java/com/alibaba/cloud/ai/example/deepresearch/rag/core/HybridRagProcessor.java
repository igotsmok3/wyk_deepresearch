 ...
 *
 * <p>
 * 项目职责：RAG 核心抽象层，将检索流程标准化为四个阶段（preProcess / hybridRetrieve / postProcess /
 * buildFilterExpression），供各检索策略统一调用。
 *
 * <p>
 * 被使用情况：由 DefaultHybridRagProcessor 实现；ProfessionalKbEsStrategy、
